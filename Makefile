...
up:
	...
	@docker-compose exec -T php /var/www/superproject/bin/console doctrine:migrations:migrate --allow-no-migration --all-or-nothing  -n
	@docker-compose exec -T php /var/www/superproject/bin/console doctrine:migrations:migrate --allow-no-migration --all-or-nothing  -n --env=test
...
tests:
	...
	@docker-compose exec -T php vendor/bin/phpunit -c phpunit.xml.dist
	@echo "\033[33mDone \033[0m"
